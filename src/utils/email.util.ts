...
export const generateCompanyApprovalEmail = (companyName: string, fullName: string, loginUrl: string): string => {
    return `
<!DOCTYPE html>
<html lang="hu">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cég regisztráció jóváhagyva</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5;">
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 24px; color: #2c3e50; font-size: 22px; font-weight: 600;">Sikeres aktiválás!</h2>
                            ...
                            <p style="margin: 0 0 24px; color: #555555; font-size: 15px; line-height: 1.6;">
                                Örömmel értesítjük, hogy a(z) <strong>${companyName}</strong> regisztrációja jóváhagyásra került a Neumann János Egyetem Duális Képzési Rendszerében.
                                Felhasználói fiókját aktiváltuk, így mostantól be tud jelentkezni a felületre.
                            </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 32px 0;">
                                <tr>
                                    <td style="border-radius: 6px; background: linear-gradient(135deg, #40B4E5 0%, #2E9FD1 100%); box-shadow: 0 4px 12px rgba(64, 180, 229, 0.3);">
                                        <a href="${loginUrl}" target="_blank" style="display: inline-block; padding: 16px 40px; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; letter-spacing: 0.3px;">
                            ...
                            <p style="margin: 0 0 12px; color: #777777; font-size: 14px; line-height: 1.5;">
                                Vagy használja az alábbi linket a böngészőjében:
                            </p>
...
export const generateWelcomeEmail = (fullName: string): string => {
    return `
<!DOCTYPE html>
<html lang="hu">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Üdvözöljük a Duális Képzési Rendszerben!</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5;">
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 24px; color: #2c3e50; font-size: 22px; font-weight: 600;">Sikeres regisztráció!</h2>
                            ...
                            <p style="margin: 0 0 24px; color: #555555; font-size: 15px; line-height: 1.6;">
                                Örömmel értesítjük, hogy regisztrációja sikeresen elkészült a Neumann János Egyetem Duális Képzési Rendszerében.
                                Fiókja mostantól aktív és használatra kész.
                            </p>
                        </td>
                    </tr>
...
export const generatePendingActivationEmail = (fullName: string): string => {
    return `
<!DOCTYPE html>
<html lang="hu">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Regisztráció jóváhagyásra vár</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5;">
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <h2 style="margin: 0 0 24px; color: #2c3e50; font-size: 22px; font-weight: 600;">Regisztráció fogadva</h2>
                            ...
                            <p style="margin: 0 0 24px; color: #555555; font-size: 15px; line-height: 1.6;">
                                Köszönjük a regisztrációját a Neumann János Egyetem Duális Képzési Rendszerében.
                            </p>

                            <p style="margin: 0 0 24px; color: #555555; font-size: 15px; line-height: 1.6;">
                                Felhasználói fiókját biztonsági okokból az egyetemi koordinátor jóváhagyása után aktiváljuk. Amint az aktiválás megtörtént, e-mailben értesítjük Önt, és ezt követően be tud majd lépni a rendszerbe.
                            </p>
                            ...
                            <div style="margin-top: 32px; padding: 20px; background-color: #e3f2fd; border-radius: 6px; border-left: 4px solid #40B4E5;">
                                ...
                                <p style="margin: 0; color: #666666; font-size: 14px; line-height: 1.7;">
                                     Jelenleg nincs további teendője. Kérjük, várja meg az egyetem jóváhagyásáról szóló visszaigazoló e-mailt.
                                </p>
                            </div>
                        </td>
                    </tr>
