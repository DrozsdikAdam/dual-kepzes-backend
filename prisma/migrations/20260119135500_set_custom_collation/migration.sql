...
ALTER TABLE "User" 
  ...
  ALTER COLUMN "password" TYPE TEXT COLLATE "hu-HU-x-icu",
...
ALTER TABLE "News" 
  ALTER COLUMN "title" TYPE TEXT COLLATE "hu-HU-x-icu",
  ALTER COLUMN "content" TYPE TEXT COLLATE "hu-HU-x-icu",
  ALTER COLUMN "targetGroup" TYPE TEXT COLLATE "hu-HU-x-icu",
  ALTER COLUMN "tags" TYPE TEXT[] COLLATE "hu-HU-x-icu";