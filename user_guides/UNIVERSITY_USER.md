...
```mermaid
graph TD
    A[Cég Elfogadja a Jelentkezést] --> B[Cég Mentort Rendel Hozzá]
    B --> C{Egyetemi Ellenőrzés}
    C --> D[Egyetemi Felügyelő Kijelölése]
    D --> E[Partnerség AKTÍV]
    E --> F{Félév Vége}
    F -- Sikeres --> G[Partnerség LEZÁRVA]
    F -- Megszakítás --> H[Partnerség MEGSZAKÍTVA]
```
